...
const organisation = {
    ...
    createInstance(organisation) {
        ...
        let tableElement = '<tr class="organisation"><td class="icon" data-url="'+organisation.icon+'"><img src="'+organisation.icon+'" alt=""></td><td class="title" data-id="'+organisation._id+'" data-title="'+organisation.title+'">'+organisation.title+'</td><td class="devices"><ul>'+devices.join('')+'</ul></td><td><ul>'+preferences.join('')+'</ul></td><td><button type="button" class="btn btn-block btn-primary delete" data-id="'+organisation._id+'" disabled>Delete</button><button type="button" class="btn btn-block btn-primary edit" data-id="'+organisation._id+'" disabled>Edit</button></td></tr>';
